...
<div class="widget widget-table">
    ...
    <div class="widget-content">
        <!--商家信息-->
        <div class="contents">
            <form id="form" action="/Admin/Business/Update" method="post">
                ...
                <table class="table table-striped table-bordered table-set">
                    ...
                    <tr>
                        <th width="8%">商家名字</th>
                        <td width="25%"><input type="text" name="name" id="name" value="<?php echo ($name); ?>"></td>
                        <td></td>
                    </tr>
                    <tr>
                        <th>网页标题</th>
                        <td><input type="text" name="webname" id="webname" value="<?php echo ($webname); ?>"></td>
                        <td></td>
                    </tr>
                    <tr>
                        <th>手机号码</th>
